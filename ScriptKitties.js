...
/* These is the part of the the code that lays out the GUI elements */
/* These is the part of the the code that lays out the GUI elements */
/* These is the part of the the code that lays out the GUI elements */
/* These is the part of the the code that lays out the GUI elements */
/* These is the part of the the code that lays out the GUI elements */
...
function generateMinorOptionsMenu() {
    ...
    for (var i=0; i<minorOptions.length; i++) {
        [label,id,preset] = minorOptions[i];
        menu += `<input type="checkbox" id="SK_${id}" onchange="verifyElementSelected(minorOptions,\'${id}\',this.checked)"${preset?' checked':''}>`;
